...
public class Json
{
    ...
    {
		boolean json5 = false;
        com.altova.json.Primitive x = o instanceof com.altova.json.Primitive ? (com.altova.json.Primitive)o : null;
        if (x != null && x.getType() == com.altova.json.Value.Type.Boolean)
			json5 = (Boolean)x.typedValue();

    	StringReader source = new StringReader(string);
    	return new com.altova.json.Document(com.altova.json.Parser.Parse(source, json5), "");
    }
    ...
    public static String Serialize(IEnumerable sequence, java.lang.Object o) throws Exception
    {
        ...
        com.altova.functions.Json.Write(sequence, output, prettyPrint, json5);
        return output.getString().toString();
    }
    
    public static com.altova.json.Document Load(com.altova.io.Input input, com.altova.json.ValueAcceptor[] schemas, boolean json5) throws IOException
    {
        ...
        switch (input.getType())
        {
            case com.altova.io.Input.IO_READER:
                value = Parser.Parse(input.getReader(), json5);
                //uri = input.getFilename();
                break;
            case com.altova.io.Input.IO_STREAM:
                value = Parser.Parse(input.getStream(), json5);
                //uri = input.getFilename();
                break;
            default:
        ...
        public void Write(com.altova.json.Value value) throws Exception
        {
            ...
            switch (value.getType())
            {
                ...
                case Number:
                    ...
                    WriteInSameLine((dec.scale() < 0 ? dec.setScale(0) : dec).toString());
                    break;
                case Boolean:
    ...
    static void Write(com.altova.json.Value value, com.altova.io.Output target, boolean prettyPrint, boolean json5) throws Exception
    {
        switch (target.getType())
        {
            case com.altova.io.Output.IO_STREAM:
                Write(value, new FileIO(target.getStream(), null, false, false).openWriteStream(), prettyPrint, json5);
                break;
    ...
    public static void Write(IEnumerable sequence, com.altova.io.Output target, boolean prettyPrint, boolean json5) throws Exception
    {
    	IEnumerator en = sequence.enumerator();
        if (!en.moveNext())
