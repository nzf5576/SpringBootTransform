...
// Parser.java
//
// This file was generated by MapForce MapForce 2019.
//
...
public class Parser
{
    static class State
    {
        ...
        public Array ParseArrayJson5() throws IOException
        {
            ...
            while (true)
            {
                ...
                else if (Current != ']') throw new UnsupportedOperationException("Invalid array syntax."); 
            }
            Skip();
            return new Array(content.toArray(new Value[0]));
        }
        ...
        String ParseStringLiteral() throws IOException
        {
            ...
            while (true)
            {
                if (Current == -1) throw new UnsupportedOperationException("JSON: Expected closing quote.");
                if (Current == '"') break;
                if (Current == '\\')
                {
                    Skip();
        ...
        Primitive ParseNumber() throws IOException
        {
            ...
            else throw new UnsupportedOperationException("Invalid number literal.");
            ...
            if (Current != -1 && Character.isLetterOrDigit((char)Current)) throw new UnsupportedOperationException("Invalid number literal.");
        ...
        Primitive ParseNumberJson5() throws IOException
        {
            ...
            if (Current == '0')
            {
                ...
                if (Current != -1 && Current != '.' && Current != 'e' && Current != 'E') throw new UnsupportedOperationException("Invalid number literal.");
                bld.append("0");
            }
            else if (Current >= '1' && Current <= '9')
            {
            ...
            else if (Current != '.') throw new UnsupportedOperationException("Invalid number literal.");
            else bld.append("0");
        ...
        public Object ParseObject() throws IOException
        {
            ...
            while (true)
            {
                ...
                SkipWS();
                if (Current != ':') throw new UnsupportedOperationException("Invalid object syntax.");
                Skip();
                Value value = Parse();
    ...
    public static Value Parse(java.io.Reader source, boolean json5) throws IOException
    {
    ...
    public static Value Parse(java.io.InputStream stream, boolean json5) throws IOException
    {
    	FileIO filestream = new FileIO(stream, null, false, false); 
