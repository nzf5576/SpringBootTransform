...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jinput2Label0 = new JLabel();
	JTextField jinput2TextField0 = new JTextField();

	JLabel joutput2Label1 = new JLabel();
	JTextField joutput2TextField1 = new JTextField();
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		if (e.getSource().equals(jStartButton)) {
			...
			{
				com.altova.io.Input input2Source = com.altova.io.StreamInput.createInput("sample.json");
				com.altova.io.Output output2Target = new com.altova.io.FileOutput("output.json");

				MappingMapTooutputObject.run(
						input2Source,
						output2Target);
